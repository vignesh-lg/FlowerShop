function cardnumbervalidation() {
    ...
    if (data) {
        ...
        document.getElementById("cardnumber1").style.display = "block";
        document.getElementById("cardnumberspace").style.display = "block";
    }
}
function validateSecurityCode() {
    ...
    if (securitynum) {
        document.getElementById("ccv1").style.display = "none";
        document.getElementById("ccvspace").style.display = "block";
    }
    else {
        document.getElementById("ccv1").style.display = "block";
        document.getElementById("ccvspace").style.display = "block";
    }
}
function ExpirydateValidation() {
    ...
    if (!month ==0) {
        ...
        document.getElementById("yearandmonth1").style.display = "none";
         document.getElementById("datespace").style.display = "block";
    }
    else {
        document.getElementById("yearandmonth1").style.display = "block";
        document.getElementById("datespace").style.display = "block";
    }
}
...
function ToHelp()
{
    ...
    document.getElementById("helperbox").style.display = "block";
}
